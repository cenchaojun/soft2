...
parser.add_argument('-c', '--config', default='config/SOFT_Tiny.yaml', type=str, metavar='FILE',
                    help='YAML config file specifying default arguments')

parser = argparse.ArgumentParser(description='SOFT Training and Evaluating')

# Dataset / Model parameters
parser.add_argument('--data',default='/home/cenzhaojun/data/dataset/ImageNet/', metavar='DIR',
